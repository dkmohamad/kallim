...
def main() -> None:
    ...
    gen.add_argument(
        "--output",
        "-o",
        help="Output directory for section MP3s",
    )
    gen.add_argument(
        "--section",
        "-s",
    ...
    # --- migrate ---
    sub.add_parser("migrate", help="One-time migration: phrases.txt -> chunks.csv")
    ...
    # --- voices ---
    sub.add_parser("voices", help="List available ElevenLabs voices")
